...
export class CoinDetailsComponent implements OnInit {
  ...
  constructor(private api: ApiService, private activatedRoute: ActivatedRoute, private currencySer: CurrencyService) { }
  ...
  getGraphData(days: number) {
    this.days = days
    this.api.getGrpahicalCurrencyData(this.coinId, this.currency, this.days).subscribe({
      next: (res) => {
        setTimeout(() => {
